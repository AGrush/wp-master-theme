...
<head>
    ...
    <!-- title tag will be generated automatically with wp_head hook -->
    <?php wp_head(); ?>
</head>
<body <?php body_class(); ?> >
    ...
    <header role="banner" class="u-margin-bottom-40">
        <div class="c-header">
            <div class="o-container u-flex u-align-justify u-align-middle">
                ...
                <!-- get_search_form first searches for searchform.php and if not found generates basic search form html -->
